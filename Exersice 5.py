...
cost_per_day_twenty_servers =  20 * cost_per_day
cost_per_month_twenty_servers = 20 * cost_per_month
budget = 918
...
print('Cost to operate twenty servers per day is ${:.2f}'.format(cost_per_day_twenty_servers))
print('Cost to operate twenty servers per month is ${:.2f}'.format(cost_per_month_twenty_servers))
